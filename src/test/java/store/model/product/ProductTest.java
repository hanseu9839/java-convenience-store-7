...
public class ProductTest {
    ...
    void 상품_할인_저장_테스트() {
        ...
        assertThat(product).isEqualTo(new Product("콜라", Price.from(1000), Quantity.from(10), Quantity.from(0), "탄산2+1"));
    }
    ...
    void 싱품_재고_없음_저장_테스트() {
        ...
        Product product = Product.from(input);
        assertThat(product).isEqualTo(new Product("오렌지주스", Price.from(1800), Quantity.from(0), Quantity.from(0), "주스2+1"));
    }
